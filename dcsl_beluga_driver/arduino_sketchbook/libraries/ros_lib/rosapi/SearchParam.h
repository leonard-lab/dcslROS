...
static const char SEARCHPARAM[] = "rosapi/SearchParam";
  ...
  class SearchParamResponse : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t * length_global_name = (uint32_t *)(outbuffer + offset);
      *length_global_name = strlen( (const char*) this->global_name);
      offset += 4;
    ...
    {
      int offset = 0;
      uint32_t length_global_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
