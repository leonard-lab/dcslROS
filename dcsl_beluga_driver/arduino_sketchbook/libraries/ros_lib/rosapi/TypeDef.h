  ...
  class TypeDef : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_fieldnamesi = (uint32_t *)(outbuffer + offset);
      *length_fieldnamesi = strlen( (const char*) this->fieldnames[i]);
      offset += 4;
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_fieldtypesi = (uint32_t *)(outbuffer + offset);
      *length_fieldtypesi = strlen( (const char*) this->fieldtypes[i]);
      offset += 4;
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_examplesi = (uint32_t *)(outbuffer + offset);
      *length_examplesi = strlen( (const char*) this->examples[i]);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      for( uint8_t i = 0; i < fieldnames_length; i++){
      uint32_t length_st_fieldnames = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      for( uint8_t i = 0; i < fieldtypes_length; i++){
      uint32_t length_st_fieldtypes = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      for( uint8_t i = 0; i < examples_length; i++){
      uint32_t length_st_examples = *(uint32_t *)(inbuffer + offset);
      offset += 4;
